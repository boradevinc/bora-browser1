...
#
# Generated by make_domsub_script.py, part of the bora-browser project:
# https://github.com/ungoogled-software/bora-browser
#
...
echo "Applying bora-browser domain substitution to {len(files_list)} files ..."
